...
def lsm(n_inputs, n_classes, n_steps, epoches, x_train, x_test, y_train, y_test, classifier, data_set):
    ...
    r9 = reservoir.ReservoirLayer(200, 150, n_steps, dim2, is_input=True, homeostasis=True)
    r10 = reservoir.ReservoirLayer(200, 150, n_steps, dim2, is_input=True, homeostasis=True)
    r11 = reservoir.ReservoirLayer(200, 150, n_steps, dim2, is_input=True, homeostasis=True)
    r12 = reservoir.ReservoirLayer(200, 150, n_steps, dim2, is_input=True, homeostasis=True)

    r13 = reservoir.ReservoirLayer(300, 150, n_steps, dim2, is_input=True, homeostasis=True)
    r14 = reservoir.ReservoirLayer(300, 150, n_steps, dim2, is_input=True, homeostasis=True)

    r15 = reservoir.ReservoirLayer(300, 200, n_steps, dim3, is_input=True, homeostasis=True)
